...
<link href="<c:url value='/css/jquery.treeview.css'/>" rel="stylesheet" type="text/css" />
...
<div id="nav-box">
	...
	<ul id="browser" class="filetree">
		<li><span class="folder">机构管理</span>
			...
			<li><span class="file"><a onclick="urlTarget('${pageContext.request.contextPath}/mvc/institution/toInstitutionList/1');">机构列表</a></span></li>
			</c:if>
			<c:if test="${!empty pageNo }">
			<li><span class="file"><a onclick="urlTarget('${pageContext.request.contextPath}/mvc/institution/toInstitutionList/${pageNo}');">机构列表</a></span></li>
			</c:if>
